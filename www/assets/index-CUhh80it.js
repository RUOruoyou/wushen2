...
`}on_mount(){}open(){this.initReg||=(this.GetValidationImage(),$(`.validnum-box>.validnum-img`).on(`click`,()=>this.GetValidationImage()),!0)}regist(){var e=$(`#regist_name`).val().toLowerCase(),t=$(`#regist_pwd1`).val();if(!e)return O(`#regist_name`,`请输入用户名`);if(!/^[a-z0-9]{5,15}$/.test(e))return O(`#regist_name`,`用户名需要是5-10个英文字符`);if(!t)return O(`#regist_pwd1`,`请输入密码`);if(t.length<6||t.length>20)return O(`#regist_pwd1`,`密码长度在6到20之间`);if(t!=$(`#regist_pwd2`).val())return O(`#regist_pwd2`,`重复密码输入不一致，请重新输入`);var n=$(`#regist_val`).val();if(!n)return O(`#regist_valpanel`,`请输入图片中的验证码`);if(n.length!=4)return O(`#regist_valpanel`,`请输入图片中的四位验证码`);let r=0,i=/u(\d+)/.exec(location.pathname);i&&(r=parseInt(i[1]),r>0||(r=0)),A(`正在注册账号`),q.Regist({name:e,pwd:t,valno:n,guider:r},e=>{e.code==1?(A(`注册成功，正在获取服务器列表`),setTimeout(()=>window.location.reload(),500)):(O(`#regist_name`,e.result||`注册失败`),k($(`#regist_panel`)))})}GetValidationImage(){q.ValidationImage(function(e){$(`.validnum-box>.validnum-img`).attr(`src`,`data:image/svg+xml;base64,`+e)})}},ln=`万俟司马上官欧阳夏侯诸葛闻人东方赫连皇甫尉迟公羊澹台公冶宗政濮阳淳于单于太叔申屠公孙仲孙轩辕令狐锺离宇文长孙慕容鲜于闾丘司徒司空丌官司寇子车颛孙端木巫马公西乐正公良拓拔夹谷谷梁梁丘左丘东门西门`,un=`赵钱孙李周吴郑王冯陈楮卫蒋沈韩杨朱秦尤许何吕施张孔曹严华金魏陶姜戚谢邹喻柏水窦章云苏潘葛奚范彭郎`,dn=`世舜丞主产仁仇仓仕仞任伋众伸佐佺侃侪促俟信俣修倝倡倧偿储僖僧僳儒俊伟列则刚创前剑助劭势勘参叔吏嗣士壮孺守宽宾宋宗宙宣实宰尊峙峻崇崈川州巡帅庚战才承拯操斋昌晁暠曹曾珺玮珹琒琛琩琮琸瑎玚璟璥瑜生畴矗矢石磊砂碫示社祖祚祥禅稹穆竣竦综缜绪舱舷船蚩襦轼辑轩子杰榜碧葆莱蒲天乐东钢铎铖铠铸铿锋镇键镰馗旭骏骢骥驹驾骄诚诤赐慕端征坚建弓强彦御悍擎攀旷昂晷健冀凯劻啸柴木林森朴骞寒函高魁魏鲛鲲鹰丕乒候冕勰备宪宾密封山峰弼彪彭旁日明昪昴胜汉涵汗浩涛淏清澜浦澉澎澔瀚瀛灏沧虚豪豹辅辈迈邶合部阔雄霆震韩俯颁颇频颔风飒飙飚马亮仑仝代儋利力劼勒卓哲喆展帝弛弢弩彰征律德志忠思振挺掣旲旻昊昮晋晟晸朕朗段殿泰滕炅炜煜煊炎选玄勇君稼黎利贤谊金鑫辉墨欧有友闻问`,fn=`筠柔竹霭凝晓欢霄枫芸菲寒伊亚宜姬舒影荔枝思丽秀娟英华慧巧美娜静淑惠珠翠雅芝玉萍红娥玲芬芳燕彩春菊勤珍贞莉兰凤洁梅琳素云莲真环雪荣妹霞香月莺媛艳瑞凡佳嘉琼桂娣叶璧璐娅琦晶妍茜秋珊莎锦黛青倩婷姣婉娴瑾颖露瑶怡婵雁蓓纨仪荷丹蓉眉君琴蕊薇菁梦岚苑婕馨瑗琰韵融园艺咏卿聪澜纯毓悦昭冰爽琬茗羽希宁欣飘育滢馥`;function pn(e,t){t||=parseInt(Math.random()*2)+1;var n=[];if(t==2){var r=parseInt(Math.random()*ln.length);r%2==1&&--r,n.push(ln[r++]),n.push(ln[r])}else n.push(un[parseInt(Math.random()*un.length)]);return e==0?n.push(dn[parseInt(Math.random()*dn.length)]):n.push(fn[parseInt(Math.random()*fn.length)]),parseInt(Math.random()*4)>1&&(e==0?n.push(dn[parseInt(Math.random()*dn.length)]):n.push(fn[parseInt(Math.random()*fn.length)])),n.join(``)}function mn(){for(var e=`abcdefghijklmnopqrstuvwxyz`,t=`123456789`,n=[],r=parseInt(Math.random()*3)+3,i=0;i<r;i++)i<3?n.push(e[parseInt(Math.random()*e.length)]):n.push(t[parseInt(Math.random()*t.length)]);return n.join(``)}function hn(){for(var e=20,t=[],n=0;n<4;n++){var r=parseInt(Math.random()*15+1);e>=r?(n==3?r=e:e-=r,t[n]=r):(t[n]=e,e=0)}var i={};return i.str=t[0]+15,i.con=t[1]+15,i.dex=t[2]+15,i.int=t[3]+15,i}function gn(e){switch(e){case`name`:$(`#reg_name`).val(pn(+!$(`#gender_0`).is(`:checked`)));break;case`id`:$(`#reg_id`).val(mn());break;case`prop`:var t=hn();$(`#reg_str`).val(t.str),$(`#reg_con`).val(t.con),$(`#reg_dex`).val(t.dex),$(`#reg_int`).val(t.int);break}}var _n=class extends K{constructor(){super(),this.template=`
...
`}select(){var e=$(`.role-list>.select`);if(e.length){var t=e.attr(`roleid`);SendCommand(`login `+t),A(`正在进入游戏`,`#role_panel`)}}addRole(){if($(`.role-list>.role-item`).length>4)return S.Show({content:`你只能最多创建五个角色`});k($(`#addrole_panel`)),gn(`name`),gn(`prop`),gn(`id`)}delete(){var e=$(`.role-list>.select`);if(e.length){var t=e.attr(`roleid`);t&&S.Show({content:`是否确认删除角色：`+e.html(),onOK:function(){SendCommand(`deleterole `+t)}})}}},vn=class extends K{constructor(){super(),this.template=`
...
`}create(){var e={};if(e.name=$(`#reg_name`).val(),e.gender=$(`#gender_0`).is(`:checked`)?1:2,e.str=parseInt($(`#reg_str`).val()),e.con=parseInt($(`#reg_con`).val()),e.dex=parseInt($(`#reg_dex`).val()),e.int=parseInt($(`#reg_int`).val()),!/^[\u4E00-\u9FA5]{2,5}$/.test(e.name))return O(`#reg_name`,`名称格式错误，只能使用2-5位中文字符`);if(e.str<15||e.str>30)return O(`#reg_name`,`臂力需要在15-30之间`);if(e.con<15||e.con>30)return O(`#reg_name`,`根骨需要在15-30之间`);if(e.dex<15||e.dex>30)return O(`#reg_name`,`身法需要在15-30之间`);if(e.int<15||e.int>30)return O(`#reg_name`,`悟性需要在15-30之间`);if(e.str+e.con+e.dex+e.int!=80)return O(`#reg_name`,`先天属性需要在15-30之间，并且总和等于80`);A(`正在创建角色`,`#addrole_panel`),SendCommand(`createrole `+e.name+` `+e.gender+` `+e.str+` `+e.con+` `+e.dex+` `+e.int)}},Sn=class extends K{constructor(){super(),this.template=`
...
`}relogin(){k($(`#login_panel`));var e=new Date;e.setTime(-1e3);for(var t=document.cookie.split(`; `),n=0;n<t.length;n++){var r=t[n].split(`=`);document.cookie=r[0]+`=''; expires=`+e.toGMTString()}}loginIn(){var e=$(`#login_name`).val().toLowerCase(),t=$(`#login_pwd`).val();if(!e)return O(`#login_name`,`请输入用户名`);if(!/^[a-z0-9]{5,15}$/.test(e))return O(`#login_name`,`用户名格式错误,需要5-15位字母开头的字母，数字或下划线，不区分大小写`);if(!t)return O(`#login_pwd`,`请输入密码`);if(t.length<6||t.length>20)return O(`#login_pwd`,`密码长度在6到20之间`);A(`正在登录`,`#login_panel`),q.Login(e,t,e=>{e.code?wn.showServers():(O(`#login_name`,e.result||`登陆失败`),k(`#login_panel`))})}},En=new sn,Dn=new Tn,On=new cn,Y=new _n,kn=new vn,An=new yn,jn=new bn,Mn=new xn,Nn=new Sn;function Pn(){let e=$(this).attr(`nid`);k($(`#new_panel `)),$(`#news_frame`).attr(`src`,`/news/`+e+`.html`)}var Fn=class extends K{constructor(){super(),this.template=`
...
`}on_mount(){if($(`.login-content`).on(`click`,`.panel_item`,e=>this.LoginCommand(e)),$(`.role-list`).on(`click`,`.role-item`,function(){$(this).parent().find(`.select`).removeClass(`select`),$(this).addClass(`select`)}),$(`.new-list>li`).on(`click`,Pn),!x.GetUserCookie(`p`))return $(`#login_panel`).show();En.showServers()}LoginCommand(e){switch($(e.currentTarget).attr(`command`)){case`ToRolePanel`:k($(`#role_panel`));break;case`ToServerPanel`:_e(),k($(`#slist_panel`));break;case`ToLogin`:k($(`#login_panel`));break;case`Forget`:k($(`#reset_panel`));break;case`CancleRegist`:k($(`#login_panel`));break;case`Down`:k($(`#download`));break;case`ToRegist`:k($(`#regist_panel`)),On.open();break;case`Regist`:On.regist();break;case`SelectServer`:En.selectServer();break;case`LoginIn`:Dn.loginIn();break;case`ResetPwd`:kn.reset();break;case`AddRole`:Y.addRole();break;case`SelectRole`:Y.select();break;case`CreateRole`:Mn.create();break;case`BindPhone`:jn.bind();break;case`CheckValid`:jn.check();break;case`UpdatePwd`:An.update();break;case`ToUpdate`:An.open();break;case`ReLogin`:Dn.relogin();break;case`DeleteRole`:Y.delete();break}}},In={rally:`集结准备`,normal:`常规战斗`,side:`副位机制`,aspect:`四象化劫`,vulnerability:`逆脉易伤`,enrage:`七灭归劫`,terminal:`战斗终结`},Ln={rally:`phase-rally`,normal:`phase-normal`,side:`phase-side`,aspect:`phase-aspect`,vulnerability:`phase-vulnerability`,enrage:`phase-enrage`,terminal:`phase-terminal`},Rn=[`东`,`南`,`西`,`北`];function X(e){return e?String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#39;`):``}var zn={currentEventId:null,isTest:!1,stateData:null,playerId:null,expanded:!1,raidMessages:[],raidMembers:[],timerHandle:null,serverTimeOffset:0,domMounted:!1,getPlayerId(e){let t=e=>{if(e==null)return null;if(typeof e==`object`)return e.id!==void 0&&e.id!==null?String(e.id):e.playerId!==void 0&&e.playerId!==null?String(e.playerId):e.userid!==void 0&&e.userid!==null?String(e.userid):e.user_id!==void 0&&e.user_id!==null?String(e.user_id):null;let t=String(e).trim();return t.length>0?t:null};if(e!=null){let n=t(e);if(n)return n}if(typeof Process<`u`&&Process.player){let e=t(Process.player);if(e)return e}return t(this.playerId)},init(){this.domMounted||=(this.bindEvents(),!0)},bindEvents(){let e=$(`.container`);e.length&&(e.off(`.qimie`),e.on(`click.qimie`,`.qimie-bar-toggle, .qimie-summary-clickable`,e=>{e.stopPropagation(),this.toggleExpand()}),e.on(`click.qimie`,`.qimie-raid-btn`,e=>{e.stopPropagation(),this.openRaidChat()}))},toggleExpand(){this.expanded=!this.expanded;let e=$(`.qimie-status-bar`);if(e.length){e.toggleClass(`expanded`,this.expanded);let t=e.find(`.qimie-bar-toggle .glyphicon`);this.expanded?(t.removeClass(`glyphicon-chevron-down`).addClass(`glyphicon-chevron-up`),e.find(`.qimie-bar-toggle .toggle-text`).text(`收起`)):(t.removeClass(`glyphicon-chevron-up`).addClass(`glyphicon-chevron-down`),e.find(`.qimie-bar-toggle .toggle-text`).text(`详情`))}},openRaidChat(){let e=$(`.chat-panel`);if(e.length){e.removeClass(`hide`);let t=e.find(`.channel-box`);t.find(`span`).removeClass(`selected`);let n=t.find(`span[channel="raid"]`);if(!n.length){let e=t.find(`span[channel="pty"]`);n=e.length?$(`<span channel="raid">战团</span>`).insertAfter(e):$(`<span channel="raid">战团</span>`).appendTo(t)}n.addClass(`selected`),t.attr(`channel`,`raid`);let r=e.find(`.sender-box`);r.length&&r.val(``).focus()}else typeof E==`function`&&E(`raid `)},onBossEvent(e,t){if(e){if(t?this.playerId=t:typeof Process<`u`&&Process.player&&(this.playerId=Process.player),this.init(),e.action===`clear`){(!this.currentEventId||!e.eventId||this.currentEventId===e.eventId)&&this.clear();return}e.eventId&&this.currentEventId&&this.currentEventId!==e.eventId&&(this.clear(),t?this.playerId=t:typeof Process<`u`&&Process.player&&(this.playerId=Process.player),this.init()),this.currentEventId=e.eventId||this.currentEventId,this.isTest=!!(this.currentEventId&&String(this.currentEventId).indexOf(`test`)>=0),typeof e.serverNow==`number`&&!isNaN(e.serverNow)&&e.serverNow>0&&(this.serverTimeOffset=e.serverNow-Date.now()),this.stateData=Object.assign({},this.stateData||{},e),this.render(),this.startTimer()}},onRaid(e){if(e){if(this.init(),e.action===`close`){(!this.currentEventId||!e.eventId||this.currentEventId===e.eventId)&&(this.raidMessages=[],this.raidMembers=[],this.renderRaidSection());return}if(e.eventId&&this.currentEventId&&this.currentEventId!==e.eventId&&(this.raidMessages=[],this.raidMembers=[]),e.eventId&&(this.currentEventId=e.eventId),e.action===`state`)Array.isArray(e.members)?this.raidMembers=e.members:e.members&&typeof e.members==`object`&&(this.raidMembers=Object.values(e.members)),e.messages&&Array.isArray(e.messages)&&(this.raidMessages=e.messages.slice(-20).map(e=>({id:e.id||e.playerId||e.senderId,name:e.name||e.senderName||`侠士`,content:e.content||e.message||``,time:e.time||e.at||Date.now()}))),this.renderRaidSection();else if(e.action===`message`||e.content||e.message){let t={id:e.id||e.playerId||e.senderId,name:e.name||e.senderName||`侠士`,content:e.content||e.message||``,time:e.time||e.at||Date.now()};this.raidMessages.push(t),this.raidMessages.length>20&&this.raidMessages.splice(0,this.raidMessages.length-20),this.renderRaidSection()}}},clear(){this.timerHandle&&=(clearInterval(this.timerHandle),null),this.currentEventId=null,this.stateData=null,this.raidMessages=[],this.raidMembers=[],this.isTest=!1,this.playerId=null,this.serverTimeOffset=0,$(`.qimie-status-bar`).remove()},startTimer(){this.timerHandle||=setInterval(()=>{this.updateCountdown()},1e3)},getNow(){return Date.now()+(this.serverTimeOffset||0)},updateCountdown(){if(!this.stateData)return;let e=this.getNow(),t=Number(this.stateData.expiresAt);if(!isNaN(t)&&t>0){let n=Math.max(0,Math.ceil((t-e)/1e3)),r=Math.floor(n/60),i=n%60,a=(r<10?`0`+r:r)+`:`+(i<10?`0`+i:i);$(`.qimie-timer-val`).text(a)}else $(`.qimie-timer-val`).text(`--:--`);let n=this.stateData.mechanic,r=n?Number(n.expiresAt):NaN;if(!isNaN(r)&&r>0){let t=Math.max(0,Math.ceil((r-e)/1e3));$(`.qimie-mech-timer`).text(t+`s`)}else $(`.qimie-mech-timer`).text(``)},render(){if(!this.stateData)return;let e=$(`.qimie-status-bar`);if(!e.length){e=$(`<div class="qimie-status-bar"></div>`);let t=$(`.content-message`);t.length?e.insertBefore(t):$(`.container`).append(e)}let t=this.stateData,n=t.phase||`rally`,r=(this.isTest?`【测试】`:``)+(In[n]||n),i=Ln[n]||`phase-normal`,a=t.stacks||0,o=a>=6?`stacks-danger`:a>=3?`stacks-warn`:`stacks-normal`,s=Math.max(0,Number(t.bossHp)||0),c=Math.max(1,Number(t.bossMaxHp)||1),l=Math.min(100,Math.max(0,Math.round(s/c*1e3)/10)),u=``,d=!1;if(t.mechanic&&t.mechanic.type){let e=t.mechanic,n=this.getPlayerId();Array.isArray(e.targetIds)&&n&&e.targetIds.some(e=>this.getPlayerId(e)===n||String(e)===n)&&(d=!0);let r=e.type;e.type===`yinyang`?r=`阴阳断脉`:e.type===`tiangang`?r=`天罡共劫`:e.type===`aspect`?r=`四象化劫`:e.type===`miehun`||e.type===`灭魂指`?r=`灭魂指`:(e.type===`tianyin`||e.type===`七灭天音`)&&(r=`七灭天音`);let i=``;d?i=`<span class="qimie-target-me">【你被点名】</span>`:e.targetRoom?i=`<span>地点: ${X({center:`镇劫中宫`,east:`东·问剑台`,south:`南·焚天台`,west:`西·断金台`,north:`北·镇魂台`}[e.targetRoom]||e.targetRoom)}</span>`:Array.isArray(e.targetRooms)&&e.targetRooms.length?i=`<span>地点: ${X(e.targetRooms.map(e=>({center:`镇劫中宫`,east:`东·问剑台`,south:`南·焚天台`,west:`西·断金台`,north:`北·镇魂台`})[e]||e).join(`/`))}</span>`:Array.isArray(e.targetIds)&&e.targetIds.length&&(i=`<span>点名: ${e.targetIds.length}人</span>`);let a=``;if(e.requiredCount){let t=0;Array.isArray(e.participants)?t=e.participants.length:typeof e.participants==`number`?t=e.participants:e.participants&&typeof e.participants==`object`&&(t=Object.keys(e.participants).length),a=`<span>分摊: ${t}/${e.requiredCount}</span>`}u=`
            ...
            `}let f=``;if(t.aspects&&Array.isArray(t.aspects)&&t.aspects.length){f=`<div class="qimie-aspects-grid">`;for(let e=0;e<t.aspects.length;e++){let n=t.aspects[e]||{},r=Rn[e]||``,i=Math.max(0,Number(n.hp)||0),a=Math.max(1,Number(n.maxHp)||1),o=Math.min(100,Math.max(0,Math.round(i/a*100))),s=n.alive!==!1&&i>0;f+=`
...
`}on_mount(){$(`.container`).on(`click`,nr),$(`.channel-box`).on(`click`,`span`,er),$(`.combat-commands`).on(`click`,`.pfm-item`,L.Perform).on(`wheel`,L.Scroll),$(`.room-commands`).on(`wheel`,L.Scroll),$(`.sender-box`).on(`keyup`,Qn),$(`.room_items`).on(`click`,`.room-item`,Z.selectItem),$(`.bottom-bar`).on(`click`,`.tool-item,.state-bar,.item-command`,Yn),$(`.map-panel`).on(`click`,Jn),$(`.sender-btn`).on(`click`,$n),$(`.room_exits`).on(`pointerdown`,Z.before_click_exits).on(`pointerup`,Z.click_exits),$(`.room-title>.map-icon`).on(`click`,j.OpenDialog.bind(j))}},qn=0;function Jn(e){if(!$(e.currentTarget).closest(`.dialog-map`).length&&!j.SuppressRoomClick){if(qn||=0,Date.now()-qn>500){qn=Date.now();return}j.OpenDialog()}}function Yn(e){var t=$(this).attr(`command`);return t?Xn(t):(t=$(this).attr(`cmd`),t&&SendCommand(t),!1)}function Xn(e){switch(e){case`showtool`:St();break;case`showchat`:return Zn();case`showcombat`:return L.Show();case`stopstate`:if(G.extend.is_record)return G.extend.stop_record();SendCommand(`state stop`);break;case`stateinfo`:SendCommand(`state info`);break;default:G.show(e);break}return!1}function Zn(){var e=$(`.chat-panel`).toggleClass(`hide`);return e.is(`.hide`)?Hn=!1:(Hn=!0,e.find(`input`).val(``).focus()),!1}function Qn(e){e.keyCode==13&&$n()}function $n(){var e=$(`.sender-box`),t=e.val(),n=t?String(t).trim():``;if(!n){e.val(``).focus();return}if(n.length>100)return ReceiveMessage(`<hir>你输入的内容太多了。</hir>`);var r=$(`.channel-box`).attr(`channel`)||`chat`;e.val(``).focus(),SendCommand(r+` `+n)}function er(){var e=$(this),t=e.attr(`channel`);if(t==`emote`)return tr();if(!e.is(`.selected`)){var n=e.parent();return n.children().removeClass(`selected`),e.addClass(`selected`),n.attr(`channel`,t),$(`.sender-box`).focus(),!1}}function tr(){var e=$(`.channel-emotes`);e.is(`.hide`)?(e.removeClass(`hide`),Z.emtoes||(SendCommand(`emote`),Z.emtoes=[],$(`.sender-box`).blur(),e.on(`click`,`span`,function(){var e=$(this).html();$(`.sender-box`).val(`*`+e).focus(),$(`.channel-emotes`).addClass(`hide`)}))):$(`.channel-emotes`).addClass(`hide`)}function nr(e){var t=$(e.target);if(G.isShow&&t.is(`.container.dialog-open`))return G.hide(),S.Close(),C.Close(),!1;var n=t.attr(`cmd`);if(n||=t.parent().attr(`cmd`),n){let e=n[0];if(e==`_`){var r=n.split(` `);switch(r[0]){case`_confirm`:S.Process(r);break;case`_setting`:F.save(r[1],r[2]);break;case`_trade`:G.trade.confirm(r[1]);break;case`_close`:se.Close(t);break;case`_hide`:break;case`_closed`:G.hide();case`_party`:G.party.command(r[1]);break}}else e===`#`?M.run(n):(Wn(n)?Gn():G.curItem===`item`&&G.item&&G.item.isShow&&t.closest(`.dialog-item-dialog`).length>0?G.item.captureNextPrompt():G.isShow&&C.captureNext(),SendCommand(n),!t.closest(`.dialog-fb`).length&&!t.closest(`.dialog-item-subdialog`).length&&t.closest(`.dialog-content`).length>0&&t.closest(`.item-commands`).remove());return!1}else Hn&&(t.closest(`.chat-panel`).length||($(`.chat-panel`).addClass(`hide`),Hn=!1));S.Close(),C.Close()}window.HandlerMenuCommand=Xn;var rr=new Fn,ir=new Kn,ar=class extends K{constructor(){super(),this.template=`${rr.render()}\n${ir.render()}`}on_mount(){rr.on_mount(),ir.on_mount()}};globalThis.$=e,globalThis.SendCommand=E,globalThis.ReceiveMessage=D,globalThis.Confirm=S,globalThis.Warn=se,globalThis.CmdPrompt=C,globalThis.Process=Z,globalThis.Dialog=G;function or(){let e=new ar;e.onCompile(),e.mount(document.body),Z.init()}e(or);