...
this.set({ name: "火龙棍", desc: "这是一把在火龙王附近找到的棍子，因为长期在充满火焰的地方，它本身也带了一些火毒", unit: "根", grade: 3, eq_type: EQUIP_TYPE.WEAPON, weapon_type: WEAPON_TYPE.CLUB, value: 120000, hole_count: 2, prop: { gj: 105, str: 10, con: 10 } });
