...
this.set({ name: "火龙鞭", desc: "这是一把在火龙王附近找到的鞭子，因为长期在充满火焰的地方，它本身也带了一些火毒", unit: "条", grade: 3, eq_type: EQUIP_TYPE.WEAPON, weapon_type: WEAPON_TYPE.WHIP, value: 120000, hole_count: 2, prop: { gj: 100, str: 10, dex: 10 } });
