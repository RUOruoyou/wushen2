...
this.set({ name: "火龙拳", desc: "这是一把在火龙王附近找到的拳套，因为长期在充满火焰的地方，它本身也带了一些火毒", unit: "副", grade: 3, eq_type: EQUIP_TYPE.WEAPON, weapon_type: WEAPON_TYPE.NONE, value: 120000, hole_count: 2, prop: { gj: 100, str: 10, con: 10 } });
