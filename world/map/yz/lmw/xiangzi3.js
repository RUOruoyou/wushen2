...
this.set_item("men", "大铁门", "这扇大门紧闭，背后不知道藏了什么东西。", [[
    "tui", "推", function (me) {
        if (this.query_exits("north")) return me.notify("大铁门已经被推开了。");
        var obj = this.find_obj_bypath("yz/lm/liumang");
        if (obj) return me.notify("流氓拦在旁边，你没法安心推门。");
        me.send_room("$N使劲推了下大铁门，铁门吱呀一声开了，北面露出一间仓库。");
        this.add_exit("north", "yz/lmw/cangku");
    }
]]);
