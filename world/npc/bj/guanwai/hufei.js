...
this.on_accept = function (me, obj, count) {
    ...
    if (obj.is("sp/bj/yanji")) {
        ...
        var book = me.add_obj(["book/bc#hujiadaofa", "book/bc#sixiangbu", "book/bc#lengyueshengong"].random());
        if (book) me.notify("胡斐给了你一" + book.unit + book.color_name + "。");
        return true;
    }
}
