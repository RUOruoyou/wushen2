...
this.set_drop({ obj: "money/silver", min: 35, max: 70 }, { obj: "eq/fb/binghuo/lihuozhu", odds: 1200 });
this.on_died = function (killer) {
    ...
    killer.environment.grant_fb_milestone(killer, "炎龙王", values["炎龙王"] || 0);
};
