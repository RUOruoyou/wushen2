...
this.on_died = function (killer) {
    ...
    killer.environment.set_temp(killer, "fb/yihuagong/firebrand", 1);
    killer.notify("宫女尸身旁找到一枚火折子，足够照亮副本暗道。");
    killer.environment.grant_fb_milestone(killer, "宫女二", 10);
};
