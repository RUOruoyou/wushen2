...
this.set_drop({ obj: "money/silver", min: 35, max: 70 }, { obj: ["eq/fb/xingxiu/bilinzheng", "eq/fb/xingxiu/shenmu_wangding"], odds: 1200 });
this.on_died = function (killer) {
    if (!killer || !killer.is_player || !killer.environment || !killer.environment.is_fb()) return;
    killer.environment.grant_fb_milestone(killer, "丁春秋", 65);
};
