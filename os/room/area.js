...
AREA.prototype.query_exp = function () {
    if (this.exp > 0) return this.exp;
    var lv = this.fb_index || 0;
    return 1000 + lv * 100;
}
AREA.prototype.query_pot = function () {
    if (this.pot > 0) return this.pot;
...
AREA.prototype.query_quick_drops = function (isdiff) {
    var drops = isdiff && this.diff_quick_drops ? this.diff_quick_drops : this.quick_drops;
...
AREA.prototype.query_drops = function (isdiff) {
    ...
    var quick_drops = this.query_quick_drops(false);
    if (quick_drops) {
        this.drop_list = quick_drops;
...
AREA.prototype.query_diff_drops = function (isdiff) {
    ...
    var quick_drops = this.query_quick_drops(true);
    if (quick_drops) {
        this.diff_drop_list = quick_drops;
