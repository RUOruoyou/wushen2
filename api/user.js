...
try {
    ...
    svgCaptcha = {
        create: function () {
            ...
            const data = `<svg xmlns="http://www.w3.org/2000/svg" width="120" height="40"><rect width="120" height="40" fill="#337AB7"/><text x="18" y="27" font-size="22" fill="#fff" font-family="Arial">${text}</text></svg>`;
            return { text, data };
        }
    };
}
